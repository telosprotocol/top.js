...
class ClaimNodeRewardMethod extends AbstractObservedTransactionMethod {
    ...
    getArgs(methodArguments) {
        ...
        targetAction.set_acton_name("claim_node_reward");
...
module.exports = ClaimNodeRewardMethod;