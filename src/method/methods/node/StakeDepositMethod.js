...
class StakeDepositMethod extends AbstractObservedTransactionMethod {
    ...
    getArgs(methodArguments) {
        let { latest_tx_hash_xxhash64, nonce, token, sequence_id, note, from, mortgage } = methodArguments[0];
        ...
        const txActionParam = actionParam.ActionAssetOutParam('', mortgage);
        ...
        targetAction.set_acton_name("stake_deposit");
        targetAction.set_action_param('0x');
...
module.exports = StakeDepositMethod;