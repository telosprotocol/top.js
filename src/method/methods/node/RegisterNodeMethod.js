...
class RegisterNodeMethod extends AbstractObservedTransactionMethod {
    ...
    getArgs(methodArguments) {
        let { latest_tx_hash_xxhash64, nonce, token, sequence_id, note, from, mortgage, nodeType, nickname, key } = methodArguments[0];
...
module.exports = RegisterNodeMethod;