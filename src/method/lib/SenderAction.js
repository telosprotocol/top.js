...
class SenderAction {
    ...
    serialize_write(stream) {
        ...
        stream.uint32(this.action_hash)
            ...
            .string(this.tx_sender_account_addr)
    ...
    get_tx_sender_account_addr() {
        return this.tx_sender_account_addr;
    }

    set_tx_sender_account_addr(tx_sender_account_addr) {
